...
for (let i = 0; i < inputsWithDatalist.length; i++) {
  let input = inputsWithDatalist[i];
  input.disabled;
  console.log("inputWithDatalist",input);
  let idAttributeForDatalist= input.list;
...
let respectiveDatalistDivOPtions = idAttributeForDatalist.children;
for (let i = 0; i < respectiveDatalistDivOPtions.length; i++) {
    let respectiveDatalistDivOPtion = respectiveDatalistDivOPtions[i];
