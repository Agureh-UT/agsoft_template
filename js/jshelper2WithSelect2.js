...
function addNewRow() {
  ...
  //SELECT1 START
  let selectBlock1 = _CN("select", { class: "form-control client_id", id: `client_id_${newValue}`, name: `client_id_${newValue}`, onchange: 'changeHandler(this)', style: 'width:200px', 'data-originalvalue': "" });
  ...
  let userInputs = {
    ...
    "originalvalue": selectBlock1.dataset.originalvalue
  };
  fetch(urlFetchCostAndBudgetlines, {
    method: 'POST',
    body: new URLSearchParams(userInputs),
